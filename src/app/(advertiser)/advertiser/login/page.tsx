        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" placeholder={l.emailPh} value={email} onChange={(e) => setEmail(e.target.value)} onBlur={() => handleBlur("email")}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <PasswordInput placeholder={l.passwordPh} value={password} onChange={(e) => setPassword(e.target.value)} onBlur={() => handleBlur("password")}
